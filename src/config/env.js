...
const config = {
  ...
  refreshMarketFetchLimit: parseInt(process.env.REFRESH_MARKET_FETCH_LIMIT || process.env.MARKET_FETCH_LIMIT || '0', 10),
  refreshMarketListCacheLimit: parseInt(process.env.REFRESH_MARKET_LIST_CACHE_LIMIT || '50', 10),
  refreshTrendingFetchLimit: parseInt(process.env.REFRESH_TRENDING_FETCH_LIMIT || '20', 10),
  refreshTrendingCacheLimit: parseInt(process.env.REFRESH_TRENDING_CACHE_LIMIT || '10', 10),
