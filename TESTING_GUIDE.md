...
## Overview
This guide covers the testing infrastructure for the Polyscope Prediction Engine. We use Jest as our testing framework with comprehensive coverage of unit, integration, and API tests.
...
Tests use a separate test environment configured in `jest.setup.js`:
- Test database: `mongodb://localhost:27017/polyscope_test`
- Test port: `3001`
...
### Specific Test File
```bash
npm test -- predictionEngine.test.js
```
...
├── services/
│   ├── __tests__/
│   │   ├── predictionEngine.test.js # Unit tests
│   │   ├── llmService.test.js       # Unit tests
│   │   └── ...
│   └── ...
```
